...
export default function FeaturedCollection() {
    ...
    return (
        <section className="featured-products-section">
            <h2 className="section-title ls-n-10 m-b-2 border-0 d-flex align-items-center">Hot bids <img className="ml-2" src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple@6.0.1/img/apple/64/1f525.png" width="30" height="30" alt="Item"/></h2>
                        ...
                        <div className="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <div className="toolbox-item toolbox-sort select-custom d-flex align-items-center justify-content-center mb-0" onClick={openList}>
                                ...
                                <ul className="sort-list">
                                    ...
                                    <li className="no-hover p-0 mb-1">
