                    ...
                    showTopNotice ?
                        <div className="top-notice text-white">
                            <div className="container text-center">
                                <h5 className="d-inline-block mb-0">Rarible mobile app with widgets is live 📱</h5>
                                <button title="Close" type="button" onClick={closeTopNotice} className="mfp-close">×</button>
                            </div>
                        </div>
                        : ''
                }
